...
export function pripremiPutanjeResursKorisnika(server, konf) {
    ...
    server.delete("/rest/korisnici", restKorisnik.deleteKorisnici.bind(restKorisnik));
    server.get("/rest/korisnici/me", restKorisnik.getKorisnikMe.bind(restKorisnik));
    server.get("/rest/korisnici/:korime", restKorisnik.getKorisnik.bind(restKorisnik));
    server.post("/rest/korisnici/:korime/prijava", restKorisnik.getKorisnikPrijava.bind(restKorisnik));
    server.put("/rest/korisnici/:korime/prijava", restKorisnik.putKorisnikPrijava.bind(restKorisnik));
    server.put("/rest/korisnici/:korime", restKorisnik.putKorisnik.bind(restKorisnik));
    server.put("/rest/korisnici/:korime/status", restKorisnik.putKorisnikStatus.bind(restKorisnik));
}
...
export function pripremiPutanjeResursSerija(server, konf) {
...
export function pripremiPutanjeResursStatistika(server, konf) {
